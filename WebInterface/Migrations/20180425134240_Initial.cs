        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    SubTypeSubDishTypeID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishTypes", x => x.DishTypeID);
                    table.ForeignKey(
                        name: "FK_DishTypes_SubDishTypes_SubTypeSubDishTypeID",
                        column: x => x.SubTypeSubDishTypeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishTypes_SubTypeSubDishTypeID",
                table: "DishTypes",
                column: "SubTypeSubDishTypeID");
